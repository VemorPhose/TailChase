...
Use the smallest change that solves the issue. TailChase handles local logs, prompts, and repository metadata, so changes should stay auditable and conservative by default.
...
Good first issues should be small, testable, and avoid broad behavior changes. Useful areas include:
